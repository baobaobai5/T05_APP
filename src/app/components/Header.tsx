    ...
    <header className="fixed top-0 left-1/2 z-[70] w-full max-w-[430px] -translate-x-1/2 bg-background/92 backdrop-blur-2xl border-b border-border/40">
      <div className="px-4 pt-3 pb-2.5">
        ...
        >
          ...
          <div className="flex h-9 w-full items-center rounded-2xl border border-border/40 bg-muted/60 pl-10 pr-10 text-[14px] text-muted-foreground/70 transition-all">
            搜索感兴趣的内容...
          </div>
          <span className="absolute right-2.5 top-1/2 flex h-5 w-5 -translate-y-1/2 items-center justify-center">
